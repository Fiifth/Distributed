...
public class FileListAgent{
	...
	NodeData nodeData1;
	ArrayList<FileData> agentLockList;
	
	public FileListAgent(NodeData nodeData1, TreeMap<Integer,ArrayList<FileData>> allAgentNetworkFiles,ArrayList<FileData> agentLockList) 
	{
